...
```{bash, include=FALSE, warning=FALSE, message=FALSE}
...
# la ecuación de la exponencial,
      annotate("label", x=5, y=30, label=TeX('$y  =  1.7  e^{0.12  x }$')) +
...
```{r}
library(bookdown)
knitr::include_graphics("/home/murphy/Repos/plotcovid19mx/Rplot.pdf")
```
